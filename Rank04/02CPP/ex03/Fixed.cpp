...
/*   Updated: 2023/09/28 01:33:56 by pnopjira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed::Fixed(float const value): _FixedValue(std::roundf(value * ( 1 << getFractionalBits()))){
}
...
float   Fixed::toFloat(void) const{
    return static_cast<float>(this->getRawBits()) / (1 << getFractionalBits());
}
